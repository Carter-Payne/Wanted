...
public class game {
	private static int WantedCharacter=1;	
	private static int cry=1;
	private static int level=0;
	private static JFrame gamer;
	private static JLabel Character;
	private static JLabel TopScreen;
	private static JLabel BottomScreen;
	private static ImageIcon img;
	private static JPanel screen;
	private static JLabel grid;
	private static JLayeredPane pane;
	private static int soughtcharacters;
	private static ImageIcon car;
	...
	private static ImageIcon MC;
	private static JLabel levelcounter;
...
public void PlayGame() {
	...
	mainc.addActionListener(new ActionListener(){
		...
		private void runAgain() {
			...
			win.setLayout(null);
			win.setSize(256,406);
			JLabel caught= new JLabel("GUI/CAUGHT!");
